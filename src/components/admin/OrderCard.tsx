...
export default function OrderCard({ order, onAdvance, nextStatus, onDelete }: OrderCardProps) {
      ...
      <div className="bg-white dark:bg-neutral-900 rounded-xl border border-gray-100 dark:border-neutral-800 p-4 shadow-sm animate-fadeIn">
        ...
        <div className="flex items-center justify-between pt-3 border-t border-gray-100 dark:border-neutral-800">
          ...
          <div className="flex items-center gap-2">
            ...
            {onDelete && order.status === 'concluido' && (
              <button
                onClick={onDelete}
                className="p-2 rounded-lg text-red-500 hover:text-red-700 hover:bg-red-50 dark:hover:bg-red-500/10 transition-all"
                title="Apagar pedido"
